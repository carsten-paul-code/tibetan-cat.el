...
(ert-deftest tibetan-analysis-generate-content-has-no-phonetics ()
  "Phonetics retired 2026-09-15 on the user's request (\"phonetic
brauche ich nicht mehr — kann überall raus\").  Inverts the
2026-05-19 emission test: generated content must carry NO
`** Phonetics' heading and no `[Phonetics not available]'
placeholder.  Legacy files lose the section on their next
reanalyze (regenerate-auto rebuild — the F1/Detailed-Dictionary
