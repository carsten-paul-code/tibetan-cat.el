...
;; RETIRED (F1, 2026-07-22): the three Detailed-Dictionary renderer
;; tests (anchors-under-stem, deduplicates-stems, no-bialek-fallback)
;; left with tibetan-analysis--render-detailed-dictionary itself.
;; The multisource DATA tests above are untouched.
