...
;; ============================================================================
;; RETIRED (D1a, 2026-07-28): the COMPOUND-AWARE VOCABULARY EXTRACTION
;; subtree — `tibetan-vocab-extract-detailed' + the four
;; `tibetan-vocab-format-{entry,list}-{short,full}' formatters — had
;; ZERO production callers (grep-verified; the §5.21 CAT-Gloss and F1
;; Detailed-Dictionary retirements orphaned it).  The live extraction
;; path is `tibetan-extract-vocabulary' (core/tibetan-vocabulary.el);
;; the live per-word path is `tibetan-vocab-lookup-detailed' above.
;; ============================================================================
