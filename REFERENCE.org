...
#+DATE: 2026-09-24T14:27:46
#+OPTIONS: toc:2 num:nil

Source tree: ~/Users/cp/tibetan-cat.el~  ·  78 modules  ·  1483 forms
...
* Quick Index
  ...
  - [[#analysis/tibetan-gloss-table.el][analysis/tibetan-gloss-table.el]]  (14)
  - [[#analysis/tibetan-interlinear.el][analysis/tibetan-interlinear.el]]  (22)
  ...
  - [[#analysis/tibetan-reading.el][analysis/tibetan-reading.el]]  (25)
  - [[#analysis/tibetan-sanskrit-reading.el][analysis/tibetan-sanskrit-reading.el]]  (7)
  ...
  - [[#core/tibetan-dharmamitra-translation.el][core/tibetan-dharmamitra-translation.el]]  (15)
  ...
  - [[#core/tibetan-sanskrit-script.el][core/tibetan-sanskrit-script.el]]  (7)
  ...
  - [[#core/tibetan-utils.el][core/tibetan-utils.el]]  (14)
  - [[#core/tibetan-vocabulary-detailed.el][core/tibetan-vocabulary-detailed.el]]  (35)
  - [[#core/tibetan-vocabulary.el][core/tibetan-vocabulary.el]]  (55)
  ...
  - [[#doc-prep/tibetan-sentence-structure.el][doc-prep/tibetan-sentence-structure.el]]  (25)
  - [[#doc-prep/tibetan-wylie-ingest.el][doc-prep/tibetan-wylie-ingest.el]]  (26)
  - [[#persist/tibetan-analysis-claude.el][persist/tibetan-analysis-claude.el]]  (71)
  ...
  - [[#persist/tibetan-analysis-persist.el][persist/tibetan-analysis-persist.el]]  (154)
  - [[#persist/tibetan-analysis-sanskrit.el][persist/tibetan-analysis-sanskrit.el]]  (22)
  - [[#persist/tibetan-auto-analysis.el][persist/tibetan-auto-analysis.el]]  (29)
  - [[#persist/tibetan-cascade.el][persist/tibetan-cascade.el]]  (76)
  ...
  - [[#persist/tibetan-portfolio.el][persist/tibetan-portfolio.el]]  (5)
  - [[#persist/tibetan-sentence-claude.el][persist/tibetan-sentence-claude.el]]  (27)
  - [[#persist/tibetan-sentence-persist.el][persist/tibetan-sentence-persist.el]]  (60)
  - [[#persist/tibetan-structure-reorg.el][persist/tibetan-structure-reorg.el]]  (15)
  - [[#persist/tibetan-translation-doc.el][persist/tibetan-translation-doc.el]]  (15)
  ...
  - [[#spec/suites/sanskrit-cascade-spec.el][spec/suites/sanskrit-cascade-spec.el]]  (5)
  - [[#spec/suites/sentence-first-spec.el][spec/suites/sentence-first-spec.el]]  (5)
  ...
  - [[#workspace/tibetan-analysis-nav.el][workspace/tibetan-analysis-nav.el]]  (5)
...
* analysis/tibetan-gloss-table.el
:PROPERTIES:
:CUSTOM_ID: analysis/tibetan-gloss-table.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/analysis/tibetan-gloss-table.el
:END:

** ~tibetan-gloss-table--claude-pos~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 42
:SIGNATURE: (tibetan-gloss-table--claude-pos wylie vocab-alist)
:END:
...
** ~tibetan-gloss-table--pos-label~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 72
:SIGNATURE: (tibetan-gloss-table--pos-label pos)
:END:
...
** ~tibetan-gloss-table--token-label~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 92
:SIGNATURE: (tibetan-gloss-table--token-label tok &optional vocab-alist)
:END:
...
** ~tibetan-gloss-table--strip-escapes~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 144
:SIGNATURE: (tibetan-gloss-table--strip-escapes s)
:END:
...
** ~tibetan-gloss-table--cell~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 151
:SIGNATURE: (tibetan-gloss-table--cell s)
:END:
...
** ~tibetan-gloss-table--truncate-cell~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 171
:SIGNATURE: (tibetan-gloss-table--truncate-cell gloss)
:END:
...
** ~tibetan-gloss-table--unit-rows~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 190
:SIGNATURE: (tibetan-gloss-table--unit-rows unit-text &optional vocab-alist)
:END:
...
** ~tibetan-gloss-table--band-width~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 236
:SIGNATURE: (tibetan-gloss-table--band-width widths n)
:END:
...
** ~tibetan-gloss-table--columns-per-band~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 247
:SIGNATURE: (tibetan-gloss-table--columns-per-band widths)
:END:
...
** ~tibetan-gloss-table--format-rows~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 257
:SIGNATURE: (tibetan-gloss-table--format-rows rows)
:END:
...
** ~tibetan-gloss-table-render~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 302
:SIGNATURE: (tibetan-gloss-table-render units &optional vocab-alist)
:END:
...
** ~tibetan-gloss-table-render-captioned~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 319
:SIGNATURE: (tibetan-gloss-table-render-captioned segs &optional vocab-alist
                                                  heading-level)
:END:
...
** ~tibetan-gloss-table-cell-gloss-width~  /customize variable/
:PROPERTIES:
:KIND: defcustom
:LINE: 160
:TYPE: 'integer
...
** ~tibetan-gloss-table-max-width~  /customize variable/
:PROPERTIES:
:KIND: defcustom
:LINE: 218
:TYPE: 'integer
...
** ~tibetan-interlinear--merged-clitics~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 289
:DEFAULT: '
...
* analysis/tibetan-reading.el
:PROPERTIES:
:CUSTOM_ID: analysis/tibetan-reading.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/analysis/tibetan-reading.el
:END:

** ~tibetan-reading--particle-label~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 47
:SIGNATURE: (tibetan-reading--particle-label tibetan)
:END:

The `tibetan-interlinear--particle-patterns' label for TIBETAN
when the whole token is a known particle form, else nil.

** ~tibetan-reading--verb-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 53
:SIGNATURE: (tibetan-reading--verb-p tibetan)
:END:

Non-nil when TIBETAN resolves in the Hill verb DB.

** ~tibetan-reading--curated-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 59
:SIGNATURE: (tibetan-reading--curated-p tibetan)
:END:

Non-nil when TIBETAN is an exact curated wordlist key.

** ~tibetan-reading--wylie~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 67
:SIGNATURE: (tibetan-reading--wylie tibetan)
:END:

Deterministic Wylie of TIBETAN (fallback: the input verbatim).

** ~tibetan-reading--split-merged-clitic~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 85
:SIGNATURE: (tibetan-reading--split-merged-clitic tibetan)
:END:
...
** ~tibetan-reading--decorate-particle~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 102
:SIGNATURE: (tibetan-reading--decorate-particle wylie label prev-verb-p tibetan)
:END:

Wrap WYLIE in `=…=' or `~…~' according to LABEL and context.

** ~tibetan-reading--source-lang-sa-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 128
:SIGNATURE: (tibetan-reading--source-lang-sa-p)
:END:
...
** ~tibetan-reading--unit-tokens~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 136
:SIGNATURE: (tibetan-reading--unit-tokens unit-text)
:END:
...
** ~tibetan-reading--unit-tokens-bo~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 154
:SIGNATURE: (tibetan-reading--unit-tokens-bo unit-text)
:END:

The Tibetan body of `tibetan-reading--unit-tokens'.

** ~tibetan-reading--claude-gloss~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 196
:SIGNATURE: (tibetan-reading--claude-gloss tok)
:END:
...
** ~tibetan-reading--sanskrit-token-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 224
:SIGNATURE: (tibetan-reading--sanskrit-token-p tok)
:END:

Non-nil when TOK's Tibetan carries a Sanskrit-only sign.

** ~tibetan-reading--gloss~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 229
:SIGNATURE: (tibetan-reading--gloss tok)
:END:
...
** ~tibetan-reading--linkify~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 272
:SIGNATURE: (tibetan-reading--linkify wylie tok)
:END:
...
** ~tibetan-reading--render-token~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 286
:SIGNATURE: (tibetan-reading--render-token tok &optional main-verb-p)
:END:
...
** ~tibetan-reading-decorated-unit-line~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 330
:SIGNATURE: (tibetan-reading-decorated-unit-line unit-text &optional last-unit-p)
:END:
...
** ~tibetan-reading--decorated-unit-line-bo~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 345
:SIGNATURE: (tibetan-reading--decorated-unit-line-bo unit-text last-unit-p)
:END:

The Tibetan body of `tibetan-reading-decorated-unit-line'.

** ~tibetan-reading-decorated-lines~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 361
:SIGNATURE: (tibetan-reading-decorated-lines units)
:END:
...
** ~tibetan-reading--converb-labels~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 36
:DEFAULT: '
...
** ~tibetan-reading--postverb-converbs~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 43
:DEFAULT: '
...
** ~tibetan-reading--merged-clitics~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 76
:DEFAULT: '
...
** ~tibetan-analysis--source-lang~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 126
:END:
...
** ~tibetan-reading--sanskrit-sign-re~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 216
:DEFAULT: "[ཱཻཽྲྀཷླྀཹཾཿྃཊཋཌཎཥ]"
:END:
...
* analysis/tibetan-sanskrit-reading.el
:PROPERTIES:
:CUSTOM_ID: analysis/tibetan-sanskrit-reading.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/analysis/tibetan-sanskrit-reading.el
:END:

** ~tibetan-sanskrit-reading--tokenize-surface~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 47
:SIGNATURE: (tibetan-sanskrit-reading--tokenize-surface unit-text)
:END:
...
** ~tibetan-sanskrit-reading-parse-word-analysis~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 73
:SIGNATURE: (tibetan-sanskrit-reading-parse-word-analysis body)
:END:
...
** ~tibetan-sanskrit-reading--analysis-for-unit~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 112
:SIGNATURE: (tibetan-sanskrit-reading--analysis-for-unit unit-text)
:END:

The (:pada … :morph …) entry for UNIT-TEXT from the dynamic
text-keyed index, or nil.

** ~tibetan-sanskrit-reading-unit-tokens~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 121
:SIGNATURE: (tibetan-sanskrit-reading-unit-tokens unit-text &optional word-analysis)
:END:
...
** ~tibetan-sanskrit-reading-unit-line~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 140
:SIGNATURE: (tibetan-sanskrit-reading-unit-line unit-text &optional word-analysis)
:END:
...
** ~tibetan-sanskrit-reading--word-analysis~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 36
:DEFAULT: nil
...
** ~tibetan-sanskrit-reading--punct-re~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 43
:DEFAULT: "[।॥|/.,;:!?()\"'«»]+"
...
** ~tibetan-dharmamitra-translation--input-encoding~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 360
:SIGNATURE: (tibetan-dharmamitra-translation--input-encoding file)
:END:
...
** ~tibetan-dharmamitra-translation--target-lang~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 377
:SIGNATURE: (tibetan-dharmamitra-translation--target-lang file)
:END:
...
** ~tibetan-dharmamitra-translation-fire-section~  /function/  ↗
:PROPERTIES:
:KIND: defun
:LINE: 622
:SIGNATURE: (tibetan-dharmamitra-translation-fire-section section-text label
                                                     files
                                                     &optional force)
:AUTOLOAD: t
:END:
...
* core/tibetan-sanskrit-script.el
:PROPERTIES:
:CUSTOM_ID: core/tibetan-sanskrit-script.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/core/tibetan-sanskrit-script.el
:END:

** ~tibetan-sanskrit-script-devanagari-to-iast~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 55
:SIGNATURE: (tibetan-sanskrit-script-devanagari-to-iast str)
:END:
...
** ~tibetan-sanskrit-script-normalize~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 104
:SIGNATURE: (tibetan-sanskrit-script-normalize str)
:END:
...
** ~tibetan-sanskrit-script--consonants~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 24
:DEFAULT: '
...
** ~tibetan-sanskrit-script--independent-vowels~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 35
:DEFAULT: '
...
** ~tibetan-sanskrit-script--vowel-signs~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 42
:DEFAULT: '
...
** ~tibetan-sanskrit-script--signs~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 48
:DEFAULT: '
...
** ~tibetan-sanskrit-script--virama~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 52
:DEFAULT: ?्
...
** ~tibetan-fresh-file-buffer~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 216
:SIGNATURE: (tibetan-fresh-file-buffer file)
:END:
...
** ~tibetan-vocab--ewts-normalize-key~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 478
:SIGNATURE: (tibetan-vocab--ewts-normalize-key term)
:END:
...
** ~tibetan-vocab--curated-exact-entry~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 684
:SIGNATURE: (tibetan-vocab--curated-exact-entry term)
:END:
...
** ~tibetan-vocab--curated-clitic-entry~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 728
:SIGNATURE: (tibetan-vocab--curated-clitic-entry term)
:END:
...
** ~tibetan-vocab--curated-any-entry~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 742
:SIGNATURE: (tibetan-vocab--curated-any-entry term)
:END:

Exact curated entry for TERM, or the clitic-stripped one (W6).

** ~tibetan-vocab--curated-starts-inside-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 747
:SIGNATURE: (tibetan-vocab--curated-starts-inside-p words start end)
:END:
...
** ~tibetan-vocab--iast-to-ewts~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 469
:DEFAULT: '
...
** ~tibetan-vocab--merged-clitic-suffixes~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 722
:DEFAULT: '
...
** ~tibetan-sentence--verse-line-closes-sentence-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 190
:SIGNATURE: (tibetan-sentence--verse-line-closes-sentence-p text)
:END:
...
** ~tibetan-sentence--group-verse-segments~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 205
:SIGNATURE: (tibetan-sentence--group-verse-segments segments)
:END:
...
** ~tibetan-sentence--section-genre-at-pos~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 224
:SIGNATURE: (tibetan-sentence--section-genre-at-pos &optional pos)
:END:
...
** ~tibetan--verse-starter-set~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 402
:SIGNATURE: (tibetan--verse-starter-set segs)
:END:
...
** ~tibetan-verse-sentence-max-lines~  /customize variable/
:PROPERTIES:
:KIND: defcustom
:LINE: 169
:TYPE: 'integer
...
** ~tibetan-sentence-hill-promotion-stoplist~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 132
:DEFAULT: '
...
** ~tibetan-verse-sentence-closing-particles~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 177
:DEFAULT: '
...
** ~tibetan-verse-quotative-closers~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 186
:DEFAULT: '
...
** ~tibetan-analysis--defer-mt-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 559
:SIGNATURE: (tibetan-analysis--defer-mt-p file)
:END:
...
** ~tibetan-analysis--cascade-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 578
:SIGNATURE: (tibetan-analysis--cascade-p file)
:END:
...
** ~tibetan-analysis--resolve-source-lang~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 602
:SIGNATURE: (tibetan-analysis--resolve-source-lang file)
:END:
...
** ~tibetan-analysis--defer-mt-rewrite-placeholders~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 652
:SIGNATURE: (tibetan-analysis--defer-mt-rewrite-placeholders)
:END:
...
** ~tibetan-analysis--request-claude-translation-1~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1836
:SIGNATURE: (tibetan-analysis--request-claude-translation-1 tibetan-text analysis-file &optional source-file)
:END:
...
** ~tibetan-analysis--sanitize-claude-body-stars~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2978
:SIGNATURE: (tibetan-analysis--sanitize-claude-body-stars body level)
:END:
...
** ~tibetan-analysis-defer-mt-placeholder~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 633
:DEFAULT: "[Awaiting your own draft — MT deferred: this document carries #+TIBETAN_DEFER_MT (portfolio mode).  Machine translation
:END:
...
:KIND: defun
:LINE: 181
:SIGNATURE: (tibetan-analysis--claude-vocab-gloss-for-token word vocab-alist &optional exact)
:END:
...
** ~tibetan-analysis--in-reading-interlinear-section-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 474
:SIGNATURE: (tibetan-analysis--in-reading-interlinear-section-p)
:END:
...
** ~tibetan-analysis--main-verb-matcher~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 486
:SIGNATURE: (tibetan-analysis--main-verb-matcher limit)
:END:
...
** ~tibetan-analysis--structure-format-table~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2783
:SIGNATURE: (tibetan-analysis--structure-format-table rows)
:END:
...
** ~tibetan-analysis--structure-unit-tree~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2819
:SIGNATURE: (tibetan-analysis--structure-unit-tree text)
:END:
...
** ~tibetan-analysis--structure-np-wylie~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2838
:SIGNATURE: (tibetan-analysis--structure-np-wylie np)
:END:

NP's head as plain Wylie (table cell — no script, no links).

** ~tibetan-analysis--structure-verb-cell~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2850
:SIGNATURE: (tibetan-analysis--structure-verb-cell tree)
:END:

TREE's root verb as a short Wylie cell: `byed' / `mdzad (hon.)'.

** ~tibetan-analysis--structure-detail-rows~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2864
:SIGNATURE: (tibetan-analysis--structure-detail-rows tree)
:END:
...
** ~tibetan-analysis--structure-unit-connector~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2930
:SIGNATURE: (tibetan-analysis--structure-unit-connector text)
:END:
...
** ~tibetan-analysis--structure-overview-phrases~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2948
:SIGNATURE: (tibetan-analysis--structure-overview-phrases tree)
:END:

TREE's filled slots + adjuncts as one ` · '-joined Wylie cell.

** ~tibetan-analysis--render-structure-tables~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2967
:SIGNATURE: (tibetan-analysis--render-structure-tables segs)
:END:
...
** ~tibetan-analysis--strip-leading-sense-number~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 3192
:SIGNATURE: (tibetan-analysis--strip-leading-sense-number gloss)
:END:
...
** ~tibetan-analysis--maybe-fire-dm-for-par~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 5479
:SIGNATURE: (tibetan-analysis--maybe-fire-dm-for-par filepath tibetan-text)
:END:
...
** ~tibetan-analysis--par-seg-start~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 5508
:SIGNATURE: (tibetan-analysis--par-seg-start source-file par-id)
:END:
...
** ~tibetan-analysis--regenerate-paragraph-with-context~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 5531
:SIGNATURE: (tibetan-analysis--regenerate-paragraph-with-context filepath tibetan-text par-label source-text)
:END:
...
** ~tibetan-analysis--par-id-from-filename~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 5920
:SIGNATURE: (tibetan-analysis--par-id-from-filename filepath)
:END:

Extract numeric paragraph id from FILEPATH's basename, or nil.
Matches only the par- prefix (`par-184.org', `par-184-foo.org').

** ~tibetan-analysis--source-file-from-par~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 5927
:SIGNATURE: (tibetan-analysis--source-file-from-par analysis-file)
:END:
...
** ~tibetan-analysis-reanalyze-paragraph-file~  /function (cl)/
:PROPERTIES:
:KIND: cl-defun
:LINE: 5943
:SIGNATURE: (tibetan-analysis-reanalyze-paragraph-file filepath &key source-file re-request-claude dry-run)
:END:
...
** ~tibetan-analysis--claude-render-vars~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 6005
:SIGNATURE: (tibetan-analysis--claude-render-vars existing-sections)
:END:
...
** ~tibetan-analysis--claude-sections-populated-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 6026
:SIGNATURE: (tibetan-analysis--claude-sections-populated-p sections)
:END:

Non-nil when SECTIONS carries any populated Claude body.

** ~tibetan-analysis--analysis-file-re~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 6036
:SIGNATURE: (tibetan-analysis--analysis-file-re prefix)
:END:
...
** ~tibetan-analysis--folder-analysis-files-strict~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 6047
:SIGNATURE: (tibetan-analysis--folder-analysis-files-strict folder prefix &optional relative)
:END:
...
** ~tibetan-analysis--reading-verb-font-lock-keywords~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 500
:DEFAULT: '
...
** ~tibetan-analysis--structure-role-labels-de~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 2768
:DEFAULT: '
...
** ~tibetan-analysis--gloss-table-seg-start~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 5500
:DEFAULT: nil
...
** ~tibetan-analysis-main-verb-face~  /face/
:PROPERTIES:
:KIND: defface
:LINE: 463
:END:
...
** ~tibetan-auto--analyze-document-two-file~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 366
:SIGNATURE: (tibetan-auto--analyze-document-two-file force)
:END:
...
* persist/tibetan-cascade.el
:PROPERTIES:
:CUSTOM_ID: persist/tibetan-cascade.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/persist/tibetan-cascade.el
:END:

** ~tibetan-cascade-split-shad-units~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 64
:SIGNATURE: (tibetan-cascade-split-shad-units text)
:END:
...
** ~tibetan-cascade--extract-l2-body~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 108
:SIGNATURE: (tibetan-cascade--extract-l2-body content heading)
:END:
...
** ~tibetan-cascade--unit-has-shad-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 127
:SIGNATURE: (tibetan-cascade--unit-has-shad-p unit-text)
:END:

Non-nil when UNIT-TEXT carries a trailing shad run.

** ~tibetan-cascade--renderings-list-body~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 131
:SIGNATURE: (tibetan-cascade--renderings-list-body segs)
:END:
...
** ~tibetan-cascade--reading-section~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 142
:SIGNATURE: (tibetan-cascade--reading-section segs)
:END:
...
** ~tibetan-cascade--read-gloss-tables~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 212
:SIGNATURE: (tibetan-cascade--read-gloss-tables file)
:END:
...
** ~tibetan-cascade--gloss-tables-edited-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 252
:SIGNATURE: (tibetan-cascade--gloss-tables-edited-p state)
:END:
...
** ~tibetan-cascade--restore-gloss-tables-in-buffer~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 263
:SIGNATURE: (tibetan-cascade--restore-gloss-tables-in-buffer state)
:END:
...
** ~tibetan-cascade--sentence-structure-body~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 304
:SIGNATURE: (tibetan-cascade--sentence-structure-body segs)
:END:
...
** ~tibetan-cascade--sentence-structure-body-trees~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 321
:SIGNATURE: (tibetan-cascade--sentence-structure-body-trees segs)
:END:

Legacy per-unit tree text for SEGS — the pre-2026-09-16 form,
kept as the fallback when the tabular renderer is unavailable.

** ~tibetan-cascade--scaffold~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 351
:SIGNATURE: (tibetan-cascade--scaffold sent-num segs source-file)
:END:
...
** ~tibetan-cascade--create-file~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 499
:SIGNATURE: (tibetan-cascade--create-file sent-num segs source-file)
:END:
...
** ~tibetan-cascade--subsegment-bounds~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 527
:SIGNATURE: (tibetan-cascade--subsegment-bounds seg-num)
:END:
...
** ~tibetan-cascade--subsegment-numbers~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 546
:SIGNATURE: (tibetan-cascade--subsegment-numbers file)
:END:

Ordered list of GLOBAL segment numbers under FILE's * Subsegments.
nil for nil / missing / non-cascade files; never signals.

** ~tibetan-cascade--read-subsegment-section~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 566
:SIGNATURE: (tibetan-cascade--read-subsegment-section file seg-num heading)
:END:
...
** ~tibetan-cascade--write-subsegment-section-in-buffer~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 594
:SIGNATURE: (tibetan-cascade--write-subsegment-section-in-buffer seg-num heading body)
:END:
...
** ~tibetan-cascade--write-subsegment-section~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 619
:SIGNATURE: (tibetan-cascade--write-subsegment-section file seg-num heading body)
:END:
...
** ~tibetan-cascade--read-l1-body~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 654
:SIGNATURE: (tibetan-cascade--read-l1-body file heading)
:END:
...
** ~tibetan-cascade--read-l3-body~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 675
:SIGNATURE: (tibetan-cascade--read-l3-body file heading)
:END:
...
** ~tibetan-cascade--collect-unknown-l1-sections~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 698
:SIGNATURE: (tibetan-cascade--collect-unknown-l1-sections file)
:END:

List of verbatim L1 subtrees in FILE whose headings the scaffold
does not own (`tibetan-cascade--known-l1-sections').

** ~tibetan-cascade--set-body-in-buffer~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 720
:SIGNATURE: (tibetan-cascade--set-body-in-buffer level heading body)
:END:
...
** ~tibetan-cascade--regenerate~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 743
:SIGNATURE: (tibetan-cascade--regenerate filepath sent-num segs source-file)
:END:
...
** ~tibetan-cascade--subsegment-rendering-needs-request-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 864
:SIGNATURE: (tibetan-cascade--subsegment-rendering-needs-request-p file seg-num)
:END:
...
** ~tibetan-cascade--renderings-region~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 888
:SIGNATURE: (tibetan-cascade--renderings-region)
:END:
...
** ~tibetan-cascade--rendering-line-re~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 910
:SIGNATURE: (tibetan-cascade--rendering-line-re seg-num)
:END:

Anchored regex for SEG-NUM's rendering line; body in group 1.

** ~tibetan-cascade--read-rendering~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 914
:SIGNATURE: (tibetan-cascade--read-rendering file seg-num)
:END:

SEG-NUM's rendering body in FILE, or nil.
New `- ⟦N⟧' line first; legacy `*** Rendering' subtree fallback.

** ~tibetan-cascade--write-rendering-in-buffer~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 931
:SIGNATURE: (tibetan-cascade--write-rendering-in-buffer seg-num body)
:END:
...
** ~tibetan-cascade--write-rendering~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 952
:SIGNATURE: (tibetan-cascade--write-rendering file seg-num body)
:END:
...
** ~tibetan-cascade--rendering-numbers~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 965
:SIGNATURE: (tibetan-cascade--rendering-numbers file)
:END:

Ordered global segment numbers of FILE's rendering units.
New-format ⟦N⟧ lines first; legacy subtree numbers fallback.

** ~tibetan-cascade--read-interlinear-for-unit~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 981
:SIGNATURE: (tibetan-cascade--read-interlinear-for-unit file seg-num)
:END:
...
** ~tibetan-cascade--rendering-needs-request-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1033
:SIGNATURE: (tibetan-cascade--rendering-needs-request-p file seg-num)
:END:
...
** ~tibetan-cascade--extract-span~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1060
:SIGNATURE: (tibetan-cascade--extract-span whole seg-num)
:END:
...
** ~tibetan-cascade--reassemble-subsections~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1078
:SIGNATURE: (tibetan-cascade--reassemble-subsections parsed key seg-nums
                                                &optional preamble)
:END:
...
** ~tibetan-cascade--response-word-analysis-body~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1099
:SIGNATURE: (tibetan-cascade--response-word-analysis-body response)
:END:
...
** ~tibetan-cascade--write-word-analysis~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1118
:SIGNATURE: (tibetan-cascade--write-word-analysis file body)
:END:
...
** ~tibetan-cascade--regenerate-after-land~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1161
:SIGNATURE: (tibetan-cascade--regenerate-after-land file)
:END:
...
** ~tibetan-cascade--land-response~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1198
:SIGNATURE: (tibetan-cascade--land-response response ctx)
:END:
...
** ~tibetan-cascade--prompt-grounding~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1303
:SIGNATURE: (tibetan-cascade--prompt-grounding sentence source-file folder)
:END:
...
** ~tibetan-cascade--fire-sentence~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1338
:SIGNATURE: (tibetan-cascade--fire-sentence sentence source-file folder
                                       &optional force)
:END:
...
** ~tibetan-cascade--fire-sentence-1~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1357
:SIGNATURE: (tibetan-cascade--fire-sentence-1 sentence source-file folder force)
:END:

Unguarded body of `tibetan-cascade--fire-sentence'.

** ~tibetan-cascade--collect-sentences~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1393
:SIGNATURE: (tibetan-cascade--collect-sentences)
:END:
...
** ~tibetan-cascade--collect-section-chunks~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1460
:SIGNATURE: (tibetan-cascade--collect-section-chunks)
:END:
...
** ~tibetan-cascade--build-chunk-prompts~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1529
:SIGNATURE: (tibetan-cascade--build-chunk-prompts chunk source-file)
:END:

Build (SYSTEM . USER) for a chunk-fire call over CHUNK.

** ~tibetan-cascade--chunk-translation-body~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1583
:SIGNATURE: (tibetan-cascade--chunk-translation-body response)
:END:

The `## Translation' body of RESPONSE (whole response when the
heading is absent — the markers still carry the information).

** ~tibetan-cascade--land-chunk-response~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1595
:SIGNATURE: (tibetan-cascade--land-chunk-response response ctx)
:END:
...
** ~tibetan-cascade-create-all~  /function/  ⚡  ↗
:PROPERTIES:
:KIND: defun
:LINE: 1671
:SIGNATURE: (tibetan-cascade-create-all &optional force)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
...
** ~tibetan-cascade--segs-for-sentence~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1731
:SIGNATURE: (tibetan-cascade--segs-for-sentence source-file sent-num)
:END:

SOURCE-FILE's sentence SENT-NUM as (GLOBAL-NUM . TEXT) pairs, or nil.

** ~tibetan-cascade-open-for-segment~  /function/  ↗
:PROPERTIES:
:KIND: defun
:LINE: 1745
:SIGNATURE: (tibetan-cascade-open-for-segment seg-id source-file)
:AUTOLOAD: t
:END:
...
** ~tibetan-cascade-reanalyze-file~  /function (cl)/
:PROPERTIES:
:KIND: cl-defun
:LINE: 1823
:SIGNATURE: (tibetan-cascade-reanalyze-file filepath &key source-file
                                                   re-request-claude)
:END:
...
** ~tibetan-cascade-reanalyze-for-segment~  /function/  ↗
:PROPERTIES:
:KIND: defun
:LINE: 1890
:SIGNATURE: (tibetan-cascade-reanalyze-for-segment seg-id source-file
...
** ~tibetan-cascade-file-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1922
:SIGNATURE: (tibetan-cascade-file-p filepath)
:END:
...
** ~tibetan-shad-split-segments~  /function/  ⚡  ↗
:PROPERTIES:
:KIND: defun
:LINE: 1943
:SIGNATURE: (tibetan-shad-split-segments)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
...
** ~tibetan-cascade--sanskrit-split-prose~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2043
:SIGNATURE: (tibetan-cascade--sanskrit-split-prose block)
:END:
...
** ~tibetan-cascade--sanskrit-block-verse-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2060
:SIGNATURE: (tibetan-cascade--sanskrit-block-verse-p block)
:END:

Non-nil when BLOCK reads as a verse: ≥2 lines AND a double-daṇḍa
(॥ or ||) close.  Everything else is prose.

** ~tibetan-cascade--sanskrit-split-blocks~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2067
:SIGNATURE: (tibetan-cascade--sanskrit-split-blocks text)
:END:
...
** ~tibetan-cascade-import-sanskrit~  /function (cl)/  ⚡  ↗
:PROPERTIES:
:KIND: cl-defun
:LINE: 2096
:SIGNATURE: (tibetan-cascade-import-sanskrit input output-file &key title)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
...
** ~tibetan-cascade-import-comparative~  /function/  ⚡
:PROPERTIES:
:KIND: defun
:LINE: 2196
:SIGNATURE: (tibetan-cascade-import-comparative comparative-file output-file)
:INTERACTIVE: t
:END:
...
** ~tibetan-cascade--sentence-lopez-section~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2312
:SIGNATURE: (tibetan-cascade--sentence-lopez-section source-file sent-num)
:END:

The :LOPEZ_SECTION: of the Section wrapping SENT-NUM, or nil.

** ~tibetan-cascade--section-refs-block~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2332
:SIGNATURE: (tibetan-cascade--section-refs-block sentence source-file)
:END:
...
** ~tibetan-cascade--schedule-dm-section~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2405
:SIGNATURE: (tibetan-cascade--schedule-dm-section chunk files force)
:END:
...
** ~tibetan-cascade--fire-section~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2429
:SIGNATURE: (tibetan-cascade--fire-section chunk source-file folder
                                      &optional force)
:END:
...
** ~tibetan-cascade-fire-sections~  /function/  ⚡  ↗
:PROPERTIES:
:KIND: defun
:LINE: 2496
:SIGNATURE: (tibetan-cascade-fire-sections &optional force)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
...
** ~tibetan-cascade-chunk-max-segments~  /customize variable/
:PROPERTIES:
:KIND: defcustom
:LINE: 1451
:TYPE: 'integer
...
** ~tibetan-sentence-claude--system-prompt-sanskrit~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 50
:END:
...
** ~tibetan-analysis-auto-regen-on-claude-arrival~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 51
:END:
...
** ~tibetan-cascade-rendering-placeholder~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 101
:DEFAULT: "[Awaiting sentence translation…]"
:END:
...
** ~tibetan-cascade--known-l1-sections~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 639
:DEFAULT: '
...
** ~tibetan-auto-fire-claude-on-create~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 1391
:END:
...
** ~tibetan-cascade--chunk-system-addendum~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 1492
:DEFAULT: "
...
sentences (the shad-delimited segments your user prompt l
:END:
...
** ~tibetan-cascade--chunk-system-addendum-sanskrit~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 1511
:DEFAULT: "
...
CHUNK MODE — this request covers a PASSAGE spanning several
sentences (the daṇḍa-delimited segments your user prompt 
:END:
...
** ~tibetan-dharmamitra-sentence-request-delay~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 2403
:END:
...
* persist/tibetan-portfolio.el
:PROPERTIES:
:CUSTOM_ID: persist/tibetan-portfolio.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/persist/tibetan-portfolio.el
:END:

** ~tibetan-portfolio--protocol-path~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 21
:SIGNATURE: (tibetan-portfolio--protocol-path source-file)
:END:

Absolute path of the revision protocol for SOURCE-FILE.

** ~tibetan-portfolio--collect-working-translations~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 28
:SIGNATURE: (tibetan-portfolio--collect-working-translations source-file)
:END:
...
** ~tibetan-portfolio--frozen-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 68
:SIGNATURE: (tibetan-portfolio--frozen-p protocol-file sent-num)
:END:

Non-nil when PROTOCOL-FILE already carries a frozen draft for SENT-NUM.

** ~tibetan-portfolio-freeze-draft~  /function/  ⚡  ↗
:PROPERTIES:
:KIND: defun
:LINE: 78
:SIGNATURE: (tibetan-portfolio-freeze-draft source-file)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
...
** ~tibetan-portfolio-protocol-file~  /customize variable/
:PROPERTIES:
:KIND: defcustom
:LINE: 15
:TYPE: 'string
:GROUP: tibetan-analysis
:DEFAULT: "revision-protocol.org"
:END:
...
** ~tibetan-sentence-claude--handle-response-1~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 566
:SIGNATURE: (tibetan-sentence-claude--handle-response-1 response ctx)
:END:
...
** ~tibetan-analysis--fire-sentence-level-1~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 754
:SIGNATURE: (tibetan-analysis--fire-sentence-level-1 analysis-file source-file
                                                seg-id force)
:END:

Unguarded body of `tibetan-analysis--fire-sentence-level'.

** ~tibetan-analysis--fire-sentence-level-2~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 787
:SIGNATURE: (tibetan-analysis--fire-sentence-level-2 sentence analysis-file
                                                source-file force)
:END:
...
spans one or more numbered segments (the shad-deli
:END:
...
** ~tibetan-sentence-claude--system-prompt-sanskrit~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 261
:DEFAULT: "You are an expert Sanskrit philologist assisting a Buddhist
Studies graduate thesis.  The user prompt gives ONE complet
:END:
...
:KIND: defun
:LINE: 113
:SIGNATURE: (tibetan-sentence--filepath sent-num &optional folder source-file)
:END:
...
** ~tibetan-sentence--request-claude-1~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1329
:SIGNATURE: (tibetan-sentence--request-claude-1 tibetan-text seg-nums analysis-file &optional source-file folder)
:END:
...
** ~tibetan-sentence--cascade-layout-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1581
:SIGNATURE: (tibetan-sentence--cascade-layout-p filepath)
:END:
...
** ~tibetan-sentence--reanalyze-file-two-file~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1651
:SIGNATURE: (tibetan-sentence--reanalyze-file-two-file filepath source-file re-request-claude dry-run)
:END:
...
** ~tibetan-sentence--create-all-two-file~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 1882
:SIGNATURE: (tibetan-sentence--create-all-two-file)
:END:
...
* persist/tibetan-translation-doc.el
:PROPERTIES:
:CUSTOM_ID: persist/tibetan-translation-doc.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/persist/tibetan-translation-doc.el
:END:

** ~tibetan-translation-doc--source-outline~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 44
:SIGNATURE: (tibetan-translation-doc--source-outline source-file)
:END:
...
** ~tibetan-translation-doc--working-translation~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 85
:SIGNATURE: (tibetan-translation-doc--working-translation file)
:END:

FILE's `* Working Translation' body (trimmed), nil when empty.

** ~tibetan-translation-doc--footnote-definitions~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 90
:SIGNATURE: (tibetan-translation-doc--footnote-definitions file)
:END:

FILE's `* Footnotes' body verbatim (edge-trimmed), nil when empty.

** ~tibetan-translation-doc--namespace-footnotes~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 95
:SIGNATURE: (tibetan-translation-doc--namespace-footnotes text prefix)
:END:
...
** ~tibetan-translation-doc--generated-file-p~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 122
:SIGNATURE: (tibetan-translation-doc--generated-file-p file)
:END:

Non-nil when FILE starts with the GENERATED marker.

** ~tibetan-translation-doc-build~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 130
:SIGNATURE: (tibetan-translation-doc-build source-file output-file
...
** ~tibetan-translation-doc--renderings~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 230
:SIGNATURE: (tibetan-translation-doc--renderings file)
:END:
...
** ~tibetan-translation-doc--strip-leading-drawer~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 250
:SIGNATURE: (tibetan-translation-doc--strip-leading-drawer body)
:END:
...
** ~tibetan-translation-doc-section-view~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 261
:SIGNATURE: (tibetan-translation-doc-section-view source-file par
                                                         &optional
                                                         output-file)
:END:
...
** ~tibetan-translation-doc-section~  /function/  ⚡  ↗
:PROPERTIES:
:KIND: defun
:LINE: 401
:SIGNATURE: (tibetan-translation-doc-section par)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
...
** ~tibetan-translation-doc--context-source~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 420
:SIGNATURE: (tibetan-translation-doc--context-source)
:END:
...
** ~tibetan-translation-doc~  /function/  ⚡  ↗
:PROPERTIES:
:KIND: defun
:LINE: 435
:SIGNATURE: (tibetan-translation-doc &optional from-sec to-sec)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
...
** ~tibetan-translation-doc-generated-marker~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 109
:DEFAULT: "# GENERATED by tibetan-translation-doc — NICHT VON HAND EDITIEREN"
:END:
...
** ~tibetan-translation-doc-empty-placeholder~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 115
:DEFAULT: "[Satz %d — noch keine Übersetzung]"
:END:

Visible placeholder for a sentence whose Working Translation is
still empty — gaps must be obvious in the stitched document.

** ~tibetan-translation-doc-missing-placeholder~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 119
:DEFAULT: "[Satz %d — Analysedatei fehlt]"
:END:
...
* spec/suites/sanskrit-cascade-spec.el
:PROPERTIES:
:CUSTOM_ID: spec/suites/sanskrit-cascade-spec.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/spec/suites/sanskrit-cascade-spec.el
:END:

** ~sanskrit-cascade-spec--corpus~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 77
:SIGNATURE: (sanskrit-cascade-spec--corpus dir)
:END:

Ein sa-Quelldokument (1 Section, 1 Satz, 2 Segmente); Pfad-Plist.

** ~sanskrit-cascade-spec--read~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 98
:SIGNATURE: (sanskrit-cascade-spec--read path)
:END:

/(no docstring)/

** ~sanskrit-cascade-spec--run~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 101
:SIGNATURE: (sanskrit-cascade-spec--run paths)
:END:

create-all + Satz-Fire mit gecannter Antwort; Ergebnis-Plist.

** ~sanskrit-cascade-spec--response~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 28
:DEFAULT: "## Translation
...
** ~sanskrit-cascade-spec--dir~  /variable/
:PROPERTIES:
:KIND: defvar
:LINE: 75
:DEFAULT: nil
...
* spec/suites/sentence-first-spec.el
:PROPERTIES:
:CUSTOM_ID: spec/suites/sentence-first-spec.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/spec/suites/sentence-first-spec.el
:END:

** ~sentence-first-spec--corpus~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 80
:SIGNATURE: (sentence-first-spec--corpus dir &optional populated-children)
:END:
...
** ~sentence-first-spec--read~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 121
:SIGNATURE: (sentence-first-spec--read path)
:END:

File PATH's content as a string.

** ~sentence-first-spec--fire~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 125
:SIGNATURE: (sentence-first-spec--fire paths response)
:END:
...
** ~sentence-first-spec--response-1~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 35
:DEFAULT: "## Translation
...
** ~sentence-first-spec--response-2~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 67
:DEFAULT: (replace-regexp-in-string
...
* workspace/tibetan-analysis-nav.el
:PROPERTIES:
:CUSTOM_ID: workspace/tibetan-analysis-nav.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/workspace/tibetan-analysis-nav.el
:END:

** ~tibetan-analysis-nav--source-link~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 28
:SIGNATURE: (tibetan-analysis-nav--source-link file)
:END:
...
** ~tibetan-analysis-jump-to-source~  /function/  ⚡  ↗
:PROPERTIES:
:KIND: defun
:LINE: 45
:SIGNATURE: (tibetan-analysis-jump-to-source)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
...
** ~tibetan-analysis-nav--sibling-sentence~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 72
:SIGNATURE: (tibetan-analysis-nav--sibling-sentence delta)
:END:
...
** ~tibetan-analysis-next-sentence~  /function/  ⚡  ↗
:PROPERTIES:
:KIND: defun
:LINE: 99
:SIGNATURE: (tibetan-analysis-next-sentence)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
...
** ~tibetan-analysis-previous-sentence~  /function/  ⚡  ↗
:PROPERTIES:
:KIND: defun
:LINE: 105
:SIGNATURE: (tibetan-analysis-previous-sentence)
:INTERACTIVE: t
:AUTOLOAD: t
:END:
