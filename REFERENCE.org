...
#+DATE: 2026-06-02T07:19:22
#+OPTIONS: toc:2 num:nil

Source tree: ~/Users/cp/tibetan-cat.el~  ·  68 modules  ·  1212 forms
...
* Quick Index
  ...
  - [[#analysis/tibetan-enhanced-parser.el][analysis/tibetan-enhanced-parser.el]]  (15)
  ...
  - [[#analysis/tibetan-particles.el][analysis/tibetan-particles.el]]  (2)
  ...
  - [[#analysis/tibetan-verb-classifier.el][analysis/tibetan-verb-classifier.el]]  (4)
  ...
  - [[#core/tibetan-steinert.el][core/tibetan-steinert.el]]  (14)
  ...
  - [[#core/tibetan-vocabulary.el][core/tibetan-vocabulary.el]]  (47)
  ...
  - [[#doc-prep/tibetan-document-prep-wizard.el][doc-prep/tibetan-document-prep-wizard.el]]  (22)
  ...
  - [[#doc-prep/tibetan-sentence-structure.el][doc-prep/tibetan-sentence-structure.el]]  (18)
  ...
  - [[#persist/tibetan-analysis-persist.el][persist/tibetan-analysis-persist.el]]  (95)
  ...
  - [[#philology/tibetan-madhyamaka-terms.el][philology/tibetan-madhyamaka-terms.el]]  (5)
...
:PROPERTIES:
:CUSTOM_ID: analysis/tibetan-particles.el
:SOURCE_PATH: /Users/cp/tibetan-cat.el/analysis/tibetan-particles.el
:END:

** ~tibetan-particles-safe-substr~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 17
:SIGNATURE: (tibetan-particles-safe-substr str start &optional end)
:END:

Safely extract substring from STR between START and END.
Returns empty string if indices are out of range or invalid.

** ~tibetan-analyze-particles-in-context~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 39
:SIGNATURE: (tibetan-analyze-particles-in-context tibetan-text)
:END:
...
** ~tibetan-steinert-format-matches~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 193
:SIGNATURE: (tibetan-steinert-format-matches word &optional max-rows)
:END:
...
** ~tibetan-extract-particle-text~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 155
:SIGNATURE: (tibetan-extract-particle-text particle)
:END:
...
** ~tibetan-sentence--role-display~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 524
:SIGNATURE: (tibetan-sentence--role-display role)
:END:

Return a human-readable English label for an argument ROLE symbol.

** ~tibetan-sentence--render-main-clause~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 546
:SIGNATURE: (tibetan-sentence--render-main-clause tibetan-text)
:END:
...
** ~tibetan-sentence--append-main-clause~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 627
:SIGNATURE: (tibetan-sentence--append-main-clause content tibetan-text)
:END:
...
** ~tibetan-sentence--main-clause-role-order~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 538
:DEFAULT: '
