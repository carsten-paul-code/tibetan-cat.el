...
#+DATE: 2026-06-10T08:24:10
#+OPTIONS: toc:2 num:nil

Source tree: ~/Users/cp/tibetan-cat.el~  ·  67 modules  ·  1237 forms
...
* Quick Index
  ...
  - [[#analysis/tibetan-clause-segmenter.el][analysis/tibetan-clause-segmenter.el]]  (23)
  ...
  - [[#persist/tibetan-analysis-persist.el][persist/tibetan-analysis-persist.el]]  (120)
  ...
  - [[#persist/tibetan-sentence-persist.el][persist/tibetan-sentence-persist.el]]  (55)
...
** ~tibetan-clause-seg--role-for-case~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 639
:SIGNATURE: (tibetan-clause-seg--role-for-case frame case-sym)
:END:

Resolve CASE-SYM to a role given FRAME string.

** ~tibetan-build-argument-structure~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 656
:SIGNATURE: (tibetan-build-argument-structure clauses nps)
:END:
...
** ~tibetan-clause-seg--case-frame-role-map~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 624
:DEFAULT: '
...
** ~tibetan-analysis--role-label~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2347
:SIGNATURE: (tibetan-analysis--role-label role)
:END:

Return the class-facing label for semantic ROLE (a symbol).

** ~tibetan-analysis--render-clause-structure~  /function/
:PROPERTIES:
:KIND: defun
:LINE: 2352
:SIGNATURE: (tibetan-analysis--render-clause-structure words verbs multiword-units)
:END:
...
** ~tibetan-analysis--role-order~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 2331
:DEFAULT: '
...
** ~tibetan-analysis--role-labels~  /constant/
:PROPERTIES:
:KIND: defconst
:LINE: 2335
:DEFAULT: '
