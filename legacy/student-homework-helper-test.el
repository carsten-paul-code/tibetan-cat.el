...
;; (when (file-exists-p "~/buddhist-studies/translation-tools/tibetan-grammar-analyzer-enhanced.el")
  (load-file "~/buddhist-studies/translation-tools/tibetan-grammar-analyzer-enhanced.el"))
